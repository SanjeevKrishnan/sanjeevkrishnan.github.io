;(function ($) {
    ...
    $(document).on('ready', function () {
        ...
        $('.testimonial-slider').slick({
            dots: false,
            arrows: false,
            prevArrow: '<button class="slick-prev"  type="button"><i class="fa fa-angle-right"></i></button>',
            nextArrow: '<button class="slick-next" type="button"><i class="fa fa-angle-left"></i></button>',
            infinite: true,
            centerMode: false,
            autoplay: true,
            vertical: false,
        ...
        var textOne = "I'm budding architect.",
        textTwo = "I'm technophile.",
        textThree = "I can create sensible stuff.";
